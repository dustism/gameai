...
class DeepQNetwork():
	def __init__(self, n_features, n_actions, sess, model, parent_ai = None, scope = 'DeepQNetwork', learning_rate = 1e-3, 
	...
	def max_qvalue(self, s):
		...
		return np.max(action_values, axis = 1)[0]
	...
	def learn(self):
		self.learn_step += 1
		# print('condition 1:', self.memory.index, self.batch_size)  #
		# print('condition 2:', self.learn_step, self.learn_start)   #
